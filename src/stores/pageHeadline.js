...
const bannerData = {
        hero: {
            ...
            button: {class: "headline__button--hero", 
                link: "https://github.com/netcam22/vue-demo-project", 
                text: "Check out my Github repo"},
            div: {class: ""}
        },
        react: {
                section: {class: "headline--blue headline--half", aria: "misdemeanours"},
        ...
        javascript: {
            section: {class: "headline--yellow headline--half", aria: "misdemeanours"},
            heading: {class: "headline__heading--box", 
                text: "My JavaScript project which inspired the Vue 3 Mars Rover page:"},
            paragraph: {class: "", 
                text: ""},
            button: {class: "headline__button--box", 
            link: "https://netcam22.github.io/mars-rover/public/",
            text: "Mars Rover Javascript Project"},
            div: {class: ""}
        },
        fakelandia: {
            section: {class: "headline--lime headline--thirty headline--half", aria: "misdemeanours"},
            heading: {class: "headline__heading--box", 
